...
Example:
- Before: `site.posts \| where: "quarter", "Q1" \| where_exp: "post", "post.categories contains 'weekly-review'" \| size`
- After: `site.posts | where: "quarter", "Q1" | where_exp: "post", "post.categories contains 'weekly-review'" | size`
...
4. **Conditionals** cannot contain pipes directly - must use assign statements
...
- Moved comparisons outside of conditionals using assign
